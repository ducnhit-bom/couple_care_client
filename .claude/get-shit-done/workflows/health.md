...
```bash
node "/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/get-shit-done/bin/gsd-tools.cjs" validate health
```
