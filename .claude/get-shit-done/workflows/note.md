...
- **Global scope**: `/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/notes/`)
...
2. Glob `/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/notes/` — works in any directory
