...
Use template from `/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/ducnh/Documents/projects/ninpuu/couple-care/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
