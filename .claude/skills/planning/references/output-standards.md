...
tags: [feature, bloc]  # Category tags
created: 2025-12-16
---
```
...
- **Domain**: `widget`, `bloc`, `navigation`, `repository`, `model`, `platform-channel`, `l10n`, `theme`
...
1. **Initial Analysis** → Read `.claude/docs/`, understand context
...
- Think through entire user journey across platforms
...
- Consider Flutter/Dart ecosystem standards

### Security & Performance
- Address secure storage and data protection
- Identify widget rebuild performance implications
- Plan for app size optimization
- Consider platform-specific security (keychain, keystore)
