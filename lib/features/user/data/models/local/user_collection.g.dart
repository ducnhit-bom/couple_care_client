...
extension UserCollectionByIndex on IsarCollection<UserCollection> {
  Future<UserCollection?> getByRemoteId(String remoteId) {
    return getByIndex(r'remoteId', [remoteId]);
  }

  UserCollection? getByRemoteIdSync(String remoteId) {
  ...
  Future<List<UserCollection?>> getAllByRemoteId(List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'remoteId', values);
  }

  List<UserCollection?> getAllByRemoteIdSync(List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByRemoteId(UserCollection object) {
    return putByIndex(r'remoteId', object);
  }

  Id putByRemoteIdSync(UserCollection object, {bool saveLinks = true}) {
    return putByIndexSync(r'remoteId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRemoteId(List<UserCollection> objects) {
    return putAllByIndex(r'remoteId', objects);
  }

  List<Id> putAllByRemoteIdSync(List<UserCollection> objects,
      {bool saveLinks = true}) {
...
extension UserCollectionQuerySortBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> sortByRemoteId() {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQuerySortThenBy
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterSortBy> thenByRemoteId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'remoteId', Sort.asc);
    });
  }
...
extension UserCollectionQueryWhereDistinct
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctByRemoteId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQueryProperty
  ...
  QueryBuilder<UserCollection, String, QQueryOperations> remoteIdProperty() {
    return QueryBuilder.apply(this, (query) {
